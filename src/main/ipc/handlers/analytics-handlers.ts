...
import type { IAnalyticsService } from '../../../modules/analytics/interfaces'
import type {
  SpaceUsageSummary,
  RecentTrend,
  TopError,
 ...
 */
function getAnalyticsService(): IAnalyticsService {
  return container().resolve<IAnalyticsService>(ServiceNames.ANALYTICS_SERVICE)
}
...
/**
 * Export getAnalyticsService helper for use in other modules (like execution-handlers)
 */
